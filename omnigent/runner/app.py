    ...
    async def _run_turn_bg_setup_and_stream(
        ...
        if cached_spec is not None:
            ...
            if _fresh_spec.mcp_servers != cached_spec.mcp_servers:
                _rebased_spec = _spec_with_workdir_paths(_fresh_spec, cached_spec_workdir)
                if _rebased_spec is not None:
                    cached_spec = _rebased_spec
        ...
        if cached_spec is not None:
            ...
            _effective_instructions = compose_omniharness_instructions(
                (
            ...
            # authored instructions but the harness cannot deliver them.

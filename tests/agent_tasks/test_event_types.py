...
def test_distributor_candidate_filter() -> None:
    ...
    assert is_distributor_candidate(event_type="session.adoption", task_id=None) is False
    assert is_distributor_candidate(event_type="session.adopted", task_id="abc") is False

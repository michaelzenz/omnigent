...
export interface TranscriptProps {
  /** Active store-bound conversation whose thread projection is rendered. */
...
function TranscriptImpl({
  ...
  const worktreeActive = useChatStore((s) => s.worktreeStatus !== null);
  ...
  // rendering nothing until then avoids a flash of duplicated thread content.
  const openThreadItemsQuery = useAgentTextThreads(conversationId ?? undefined, "open");
  const resolvedThreadItemsQuery = useAgentTextThreads(conversationId ?? undefined, "resolved");
  ...
  const hasPinnedStatus = hasTasks || worktreeActive;
  ...
  return (
    <>
      ...
      {!worktreeActive && <ChatPlanAccordion className="mt-14 md:mt-12" />}
        ...
        >
          ...
          >
            ...
            <LatestTurnSpacer
              ...
              topGapPx={hasPinnedStatus ? 16 : undefined}

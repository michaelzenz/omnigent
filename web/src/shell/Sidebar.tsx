      ...
      >
        ...
        {inSettings ? (
          ...
          drawer keeps once the collapse toggle is gone. */}
            ...
            {/* Native connection controls, pinned below the scrolling session
          list. Each row self-hides when its backing shell capability is absent,
          so browsers keep an unchanged sidebar that ends with the list. */}
          ...
          >
            ...
            {gitBranch !== null && (
              <div className="flex flex-col gap-2 rounded-md border border-destructive/40 bg-destructive/5 p-3">
                ...
                <p className="text-sm text-muted-foreground">
                  You can leave this worktree in place. Omnigent will automatically reuse it the
                  next time you create a worktree.
                </p>

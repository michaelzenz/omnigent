...
import type { Session, WorktreeStatus } from "@/lib/types";
import {
...
export async function deleteConversation(id: string, deleteBranch = false): Promise<void> {
  ...
  // cleanup) or FastAPI `detail` over the bare status line so the
  // delete-failed toast is actionable instead of "404 Not Found".
